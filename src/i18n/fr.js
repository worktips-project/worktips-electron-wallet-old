export default {
    ...
    menuItems: {
        ...
        exit: "Quitter le portefeuille Worktips GUI",
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "worktipsd introuvable, utilisation du nœud distant"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        worktipsBalance: "Solde",
        worktipsUnlockedBalance: "Solde débloqué",
        worktipsUnlockedShort: "Débloqué",
