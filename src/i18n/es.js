export default {
    ...
    strings: {
        ...
        serviceNodeRegistrationDescription: "Introduzca la orden {registerCommand} generada por el servicio (worktipsd) que se está intentado registrar como Nodo de Servicio usando la instrucción \"{prepareCommand}\"",
        spendKey: "Clave de gasto",
